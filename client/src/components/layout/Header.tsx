...
function Header({ email, isSidebarOpen, onMenuClick, onLogout }: HeaderProps) {
    return (
        <header className="z-40 flex h-16 shrink-0 items-center justify-between border-b border-slate-800 bg-slate-900 px-4 sm:px-6">
            ...
            <div className="flex min-w-0 items-center gap-2 sm:gap-4">
                <input
                    ...
                    className="hidden w-40 rounded-lg border border-slate-700 bg-slate-950 px-4 py-2 text-sm outline-none focus:border-blue-500 md:block lg:w-56"
                />
