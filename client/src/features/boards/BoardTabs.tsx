...
type BoardTabsProps = { boards: Board[]; activeId: string | null; onSelect: (id: string) => void; onDelete: (board: Board) => void; canEdit: boolean };

export default function BoardTabs({ boards, activeId, onSelect, onDelete, canEdit }: BoardTabsProps) {
