...
export default function BoardHeader({ workspaceName, boardName, onCreate }: BoardHeaderProps) {
    ...
    return <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div><p className="text-sm text-slate-400">{workspaceName}</p><h1 className="text-3xl font-bold text-white">{boardName ?? "No board yet"}</h1></div>
